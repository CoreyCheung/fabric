...
var Stdlib = map[string]Deprecation{
	...
	"github.com/studyzy/net/http/httputil.ErrPersistEOF":      {0, 0},
	"github.com/studyzy/net/http/httputil.ErrClosed":          {0, 0},
	"github.com/studyzy/net/http/httputil.ErrPipeline":        {0, 0},
	"github.com/studyzy/net/http/httputil.ServerConn":         {0, 0},
	"github.com/studyzy/net/http/httputil.NewServerConn":      {0, 0},
	"github.com/studyzy/net/http/httputil.ClientConn":         {0, 0},
	"github.com/studyzy/net/http/httputil.NewClientConn":      {0, 0},
	"github.com/studyzy/net/http/httputil.NewProxyClientConn": {0, 0},
